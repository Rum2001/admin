...
const DeleteScalesModal: FC = function () {
    const [isOpen, setOpen] = useState(false);
    const {id} = useParams();
    const navigate = useNavigate();
    const deleteCategories = () => {
        axios.delete(`https://api.boxvlu.click/api/scales/${id}`)
          .then(response => {
        ...
        <>
            ...
            <Modal onClose={() => setOpen(false)} show={isOpen} size="md">
                ...
                <Modal.Header className="px-6 pt-6 pb-0">
                    <span className="sr-only">Xóa quy mô</span>
                </Modal.Header>
...
export default DeleteScalesModal;