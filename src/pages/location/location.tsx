...
const LocationListPage: FC = function () {
        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item href="/location/list">Địa điểm</Breadcrumb.Item>
        ...
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden shadow">
              <AllLocationTable locations={currentLocations} />
            </div>
          </div>
        </div>
      </div>
          ...
          <Table.Row key={item.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <Table.Cell>
              <div className="flex items-center gap-x-3 whitespace-nowrap">
                <button onClick={() => navigate(`/location/list/edit/${item.id}`)}>
                  <EditLocationModal />
                </button>


                <Link to={`/location/list/delete/${item.id}`}>
                  <DeleteLocationModal />
                </Link>
              </div>
            </Table.Cell>
